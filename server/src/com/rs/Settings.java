...
public final class Settings {
	...
	public static final String HOST = "127.0.0.1";//192.168.1.144
	public static final int PORT_ID = 43446;
	...
	public static final int COMBAT_XP_RATE = 5; // should be reasonable balanced
	public static final int XP_RATE = 3; // xp_rate should be reasonably balanced
	public static final int LAMP_XP_RATE = 10; // lamps boost a lot
	public static final int DROP_RATE = 1;
	public static final int DROP_QUANTITY_RATE = 5;
	public static final int CRAFT_RATE = 2;
	public static final int DEGRADE_GEAR_RATE = 5; // 5x longer
